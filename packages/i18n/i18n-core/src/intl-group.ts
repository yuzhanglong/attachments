...
import type { IntlSources, MessageMap } from './types';
...
export class IntlGroup {
   ...
   */
  public async updateCurrentLocal(newLocal: string, loadWhenNotFound = false) {
   ...
   */
  public updateIntlSources(sources: IntlSources, override = false) {
    if (override) {
